...
# Uses SeparateDatabaseAndState to safely rename indexes while updating Django's state
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # 1. Run conditional Python code on the database
        # 2. Update Django's migration state with RenameIndex operations
